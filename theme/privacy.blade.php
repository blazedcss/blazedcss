        ...
        <div class="container">
            <div class="mx-auto lg:w-3/4">
                <div class="p-4 sm:p-6 bg-dark-400">
                    ...
                    <p>
                        Dans le cadre de son activité, la plateforme <a class="inline-block text-primary hover:underline" href="https://www.blazedcss.com">www.blazedcss.com</a>, est amenée à collecter et à traiter des informations dont certaines sont qualifiées de "données personnelles". <a class="inline-block text-primary hover:underline" href="https://www.blazedcss.com">www.blazedcss.com</a> attache une grande importance au respect de la vie privée, et n’utilise que des données de manière responsable et confidentielle et dans une finalité précise.
                    </p>
                    <br/>
                    ...
                    <p>
                        Sur le site web <a class="inline-block text-primary hover:underline" href="https://www.blazedcss.com">www.blazedcss.com</a>, il y a 2 types de données susceptibles d’être recueillies :
                    </p>
                    <br/>
                    ...
                    <ul class="pl-6 list-disc sm:pl-8">
                        ...
                        <li>de personnaliser l'interface <a class="inline-block text-primary hover:underline" href="https://www.blazedcss.com">www.blazedcss.com</a> pour une experience utilisateur optimale</li>
                    </ul>
                    <br/>
                    <p>
                    Les données « web analytics » sont collectées sous forme anonyme (en enregistrant des adresses IP anonymes) par Piwik PRO, et nous permettent de mesurer l'audience de notre site web, les consultations et les éventuelles erreurs afin d’améliorer constamment l’expérience des utilisateurs. Ces données sont utilisées par <a class="inline-block text-primary hover:underline" href="https://www.blazedcss.com">www.blazedcss.com</a>, responsable du traitement des données, et ne seront jamais cédées à un tiers ni utilisées à d’autres fins que celles détaillées ci-dessus.
                    </p>
                    <br>
